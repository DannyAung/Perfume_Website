...
<body>
            ...
            <ul class="nav justify-content">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="categoryDropdown">
                        ...
                        <li><a class="dropdown-item" href="?category=unisex">Unisex</a></li>
                    </ul>
                </li>
                <li class="nav-item">
    ...
    <h2 class="mb-4 mt-5">Women's Collection</h2>
    <div class="row row-cols-1 row-cols-md-4 g-4">
        <?php
        // Query to fetch only "Women" category products
        $query = "SELECT * FROM products WHERE category = 'women' ORDER BY created_at DESC";
