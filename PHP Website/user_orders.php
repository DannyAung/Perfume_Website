        ...
        <?php foreach ($orders as $order_id => $order): ?>
            <div class="card mb-3 shadow-sm">
                <div class="card-header">
                    <strong>Order ID:</strong> <?php echo htmlspecialchars((string)$order_id); ?>
                </div>
                ...
                <div class="card-body">
                    ...
                    <p><strong>Total Price:</strong> <?php echo number_format((float)$order['total_price'], 2); ?> $</p>
                        ...
                        <?php if (!empty($order['items'])): ?>
                            <?php foreach ($order['items'] as $item): ?>
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex order-item-row">
                                    ...
                                    <?php if ($order['status'] === 'completed' && $product_id > 0): ?>
