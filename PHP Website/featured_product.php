...
<body>
    ...
    <div>
        ...
        <nav aria-label="breadcrumb" class="py-3 bg-light">
            ...
            <h2 class="fw-bold" style="margin-left: 35px;">Featured Fragrance Collection</h2>
            <p class="text-muted" style="margin-left: 35px;">
                Elevate your style with our exclusive Featured Fragrance Collection, blending timeless sophistication with modern charm.
